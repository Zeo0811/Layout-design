...
const S = {
  ...
  h1: `display: block; line-height: 1.5; font-size: 24px; font-family: ${FONT}; font-weight: bold; margin: 80px auto 40px auto; width: fit-content; color: #222222; text-align: center; padding: 0 1em; border-bottom: 8px solid #222222;`,
