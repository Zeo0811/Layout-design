...
// ── 内联样式定义（科技黑主题）───────────────────────────────────────────
const S = {
  wrapper: `font-family: ${FONT}; font-size: 15px; color: ${C.fg0}; line-height: 1.75; letter-spacing: .034em; word-wrap: break-word; hyphens: auto;`,

  // 标题：h1 居中+底部粗线 / h2 居中 / h3 左对齐 / h4-h6 纯粗体
  h1: `display: block; font-size: 1.4em; font-weight: bold; color: #222222; text-align: center; padding: 0 1em; border-bottom: 8px solid #222222; line-height: 1.5; margin: 1.4em 0 .7em;`,
  h2: `display: block; font-size: 1.2em; font-weight: bold; color: #222222; text-align: center; padding: 0 0.2em; line-height: 1.5; margin: 1.2em 0 .6em;`,
  h3: `display: block; font-size: 1.1em; font-weight: bold; color: #222222; text-align: left; line-height: 1.5; margin: 1em 0 .5em;`,
  h4: `display: block; font-size: 1em; font-weight: bold; color: #222222; margin: .9em 0 .45em;`,
  h5: `display: block; font-size: .95em; font-weight: bold; color: #222222; margin: .8em 0 .4em;`,
  h6: `display: block; font-size: .9em; font-weight: bold; color: #555555; margin: .7em 0 .35em;`,

  p: `font-size: 1em; line-height: 1.75; color: #222222; margin: .75em 0;`,

  strong:      `font-weight: bold; color: #222222;`,
  em:          `font-style: italic;`,
  code_inline: `background: rgba(0,0,0,.06); padding: 2px 6px; border-radius: 4px; font-family: "Courier New", Courier, monospace; font-size: .85em; color: #222222;`,
  ...
  blockquote_text:    `font-size: .95em; line-height: 1.7; color: #555555; margin: 0; font-style: italic;`,

  callout_wrapper: `background: #fff; border-bottom: 1px dashed #222222; border-right: 1px dashed #222222; padding: 12px 16px; margin: 1em 0; display: flex; gap: 10px; align-items: flex-start;`,
  callout_icon:    `font-size: 1.15em; flex-shrink: 0; line-height: 1.5;`,
  callout_content: `font-size: .95em; line-height: 1.75; color: #222222; flex: 1;`,
  ...
  hr: `border: none; border-top: 1px solid rgba(0,0,0,.15); margin: 1.5em 0;`,

  ul: `padding-left: 0; margin: .75em 0; list-style: none;`,
  ol: `padding-left: 0; margin: .75em 0; list-style: none;`,
  li: `font-size: 1em; line-height: 1.75; color: #222222; margin: .3em 0; padding-left: 1.4em; position: relative; display: block;`,

  img_wrapper: `margin: 1em 0; text-align: center;`,
  img:         `max-width: 100%; height: auto; border-radius: 10px; display: inline-block;`,
  img_caption: `font-size: .8em; color: #888888; margin-top: 5px; text-align: center;`,
  ...
  toggle_summary: `font-size: 1em; font-weight: bold; color: #222222; margin: .8em 0 .4em; padding-left: 1em; border-left: 3px solid rgba(0,0,0,.3);`,
  toggle_content: `padding-left: 1em; border-left: 2px solid rgba(0,0,0,.15); margin-left: 4px;`,

  table_wrapper: `overflow-x: auto; margin: 1em 0; border: 1px solid rgba(0,0,0,.15);`,
  ...
  embed_wrapper: `margin: 1em 0; background: rgba(0,0,0,.025); border: 1px solid rgba(0,0,0,.1); padding: 11px 15px;`,
  embed_label:   `font-size: .8em; color: #888888; margin-bottom: 4px;`,
  embed_link:    `font-size: .85em; color: #222222; word-break: break-all; border-bottom: 1px solid #222222; text-decoration: none;`,

  footnotes_wrapper: `margin-top: 2em; padding-top: 1em; border-top: 1px solid rgba(0,0,0,.15);`,
  footnotes_title:   `font-size: .78em; font-weight: bold; color: #888888; margin-bottom: .6em; text-transform: uppercase; letter-spacing: 1px;`,
  footnote_item:     `font-size: .78em; color: #555555; line-height: 1.7; margin: .3em 0; word-break: break-all;`,
